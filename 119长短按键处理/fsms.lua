...
-- sms.send(phone_num1,common.utf8ToGb2312("第2条短信"),sendtest2)
...
function send_sms(phone,LOC)
	sms.send(phone,common.utf8ToGb2312("我在"..LOC),sendtest2)
end